...
return [
    /*
     * The package will use this format to transform and cast your data payloads.
     */
    ...
    'transformers' => [
        ...
        \Illuminate\Support\Collection::class => \Spatie\LaravelData\Transformers\CollectionTransformer::class,
    ],
    ...
    /*
     * It is possible to disable the auto magical creation of data objects through
     * these settings.
     */
    ...
    /*
     * When using an invalid include/exclude/only/except partial, should we throw an exception?
     */
    'throw_when_invalid_partial' => true,

    /*
     * Define the validation strategy for the package.
     */
